...
class LLMApi:
    ...
    def __init__(self, is_output_discrete=True, relevance_definition="Relevance", diversity_definition="Diversity", image_definition="Relevance") -> None:
...
api = LLMApi(image_definition="cat should be wearing sunglass")
